...
public class LoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        userinfo = userinfohp.checkUserAuth(userinfo);
        if (userinfo == null) {
            ...
            httpSession.setAttribute("userid", userinfo.getUid());
            httpSession.setAttribute("username", userinfo.getUsername());
            getServletContext().getRequestDispatcher("/search.jsp?page=0").forward(request, response);
        }
    }
